...
const FACTORY_TOP10_METRICS: IndicatorMetric[] = [
  ...
  },
  {
    ...
    statusType: 'green',
    badge: '战略考核指标',
    tipText: '本单位产品平均综合能耗折标煤消耗强度（依据产品型号及合格工单核算）。',
    formula: 'e = E / M',
    formulaDesc: '月度指标。e: 产品单耗 (tce/万kVA)；E: 生产工段实际综合能源消耗 (tce)；M: 报告期合格产品产量 (万kVA)。',
    numeratorName: '各车间工段综合能耗 E',
    numeratorVal: '142.5 tce',
    denominatorName: '报告期完工产品产量 M',
    denominatorVal: '1,728 万kVA',
    dataSource: 'MES 制造执行系统产品合格工单报工与车间分时计量表计系统。',
    rawMeters: [
      { medium: '工段能耗与产品报工台账', meterCode: 'MES-PROD-OUTPUT-SB', location: '总装车间与生产科', reading: '142.5 tce / 1,728 万kVA', unit: 'tce/万kVA', coeff: '1.0', tce: '142.5' },
    ],
    trendHistory: [
      { period: '25-09', value: 0.0875, yoy: '-4.2%', mom: '-0.3%' },
      { period: '25-10', value: 0.0870, yoy: '-4.5%', mom: '-0.6%' },
